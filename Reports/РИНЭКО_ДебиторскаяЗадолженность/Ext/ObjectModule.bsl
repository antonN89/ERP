...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
	...
	ПараметрыЗапроса.Вставить("Период", КонецДня(ТекущаяДата()));
	...
	ПараметрыЗапроса.Вставить("ДатаОтчета", КонецДня(ТекущаяДата()));
	ПараметрыЗапроса.Вставить("ДатаОтчетаГраница", КонецДня(ТекущаяДата()));
	ПараметрыЗапроса.Вставить("ИспользуетсяОтборПоСегментуПартнеров", Ложь);
	// + [Rineco], [Киселев А.Н.] [09.11.2021] 
	// Задача: [№ 21927], [# Убираем календарь]
	
	// Было:
	//ПараметрыЗапроса.Вставить("Календарь", Справочники.ПроизводственныеКалендари.НайтиПоКоду("РФ"));
	// Стало:
	ПараметрыЗапроса.Вставить("Календарь", Справочники.ПроизводственныеКалендари.ПустаяСсылка());
	// - [Rineco], [Киселев А.Н.] [09.11.2021]
